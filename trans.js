...
var objectId = 'urn:adsk.objects:os.object:gyberd_forge_sample_lre6squ031fg2odn11el1gnanzbmevbr/ehc.rvt';
...
oAuth2TwoLegged.authenticate().then(function(credentials){
    DerivativesApi.translate(job,{xAdsForce:true},oAuth2TwoLegged,oAuth2TwoLegged.getCredentials()).then(function(result){
        console.log(result);
    });
},function(err){
    console.log(err);
